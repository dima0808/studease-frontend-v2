...
const Sidebar = (props) => {
  ...
  return (
    <div className="sidebar-creation">
      ...
      {isTest && <button onClick={addCollection} className="sidebar-creation__btn">Add Collection</button>}
      <button onClick={showAIGenerationBlock} className="sidebar-creation__btn">AI Generation</button>
